    ...
    <div className="flex-grow h-full flex flex-col">
      <div className="w-full h-15 p-1 bg-primary dark:bg-gray-800 shadow-md rounded-xl rounded-bl-none rounded-br-none">
        <div className="flex p-2 align-middle items-center">
          ...
          <div className="flex-grow p-2">
            <div className="text-md text-gray-50 font-semibold">Dhaym </div>
            <div className="flex items-center">
              <div className="w-2 h-2 bg-green-300 rounded-full"></div>
              <div className="text-xs text-gray-50 ml-1">Online</div>
            </div>
          </div>
          <div className="p-2 text-white cursor-pointer hover:bg-blue-500 rounded-full">
            <svg
              xmlns="http://www.w3.org/2000/svg"
              className="h-6 w-6"
              fill="none"
      ...
      <div className="w-full flex-grow bg-gray-100 dark:bg-gray-900 my-2 p-2 overflow-y-auto">
        <div className="flex items-end w-3/4">
          ...
          <div className="p-3 bg-blue-300 dark:bg-gray-800 mx-3 my-1 rounded-2xl rounded-bl-none sm:w-3/4 md:w-3/6">
        ...
        <div className="flex justify-end">
          <div className="flex items-end w-3/4 bg-blue-500 dark:bg-gray-800 m-1 rounded-xl rounded-br-none sm:w-3/4 md:w-auto">
            <div className="p-2">
              <div className="text-gray-200">
                dddfghgfghfghfghjufg gdfyhfthfg
              </div>
            </div>
          </div>
        </div>
        <div className="flex justify-end">
          <div className="flex items-end w-3/4 bg-blue-500 dark:bg-gray-800 m-1 rounded-xl rounded-br-none sm:w-3/4 max-w-xl md:w-auto">
            <div className="p-2">
              <div className="text-gray-200 ">sobbb?</div>
            </div>
          </div>
        </div>
        <div className="flex items-end w-3/4">
          ...
          <div className="p-3 bg-blue-300 dark:bg-gray-800 mx-3 my-1 rounded-2xl rounded-bl-none sm:w-3/4 md:w-3/6">
            ...
            <div className="text-gray-700 dark:text-gray-200">
              Hello bossing kumusta ang atin :)
            </div>
